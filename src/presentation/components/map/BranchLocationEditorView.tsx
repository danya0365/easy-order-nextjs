...
/**
 * Map picker for a branch's location — tap/drag to pin, "use my location" to
 * geolocate, optional address. Mirrors the lead picker; saves via
 * updateBranchLocationAction (which also revalidates the homepage map).
 */
    ...
    <form action={action} className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <span className="text-xs text-muted">
          {pos ? `${pos.lat.toFixed(5)}, ${pos.lng.toFixed(5)}` : t("notPinned")}
        </span>
