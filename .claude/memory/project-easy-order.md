...
**⏳ STILL PENDING:** nothing major parked right now. Possible follow-ups (not requested): `performedBy`/audit on orders for staff accountability; swap OSM community tiles for a real provider before heavy production load.
